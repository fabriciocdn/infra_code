...
3 - Ao passar pelos jobs acima, é feito o Build da imagem e um scan da imagem e um push para o Harbor, o registry de imagens docker privado, que está instalado no EKS. <br>
4 - Após passar pelos jobs de scan e build e push, é feito um commit e um push para o repositório de gitops, alterando a tag da imagem docker no values.yaml da aplicação, para que o ArgoCD que está também instalado no EKS, identifique a mudança e faça o Deploy no cluster EKS. Portanto o deploy fica automatizado.